...
struct memmap_desc memdesc[] = {
    ...
    #endif
    { "l1_0", 0x80000000, 0x80000000, SZ_256M, MT_WRITEBACK_RW_ALLOC},
    { "l1_1", 0x90000000, 0x90000000, SZ_256M, MT_WRITEBACK_RW_ALLOC},
    { "l1_2", 0xA0000000, 0xA0000000, SZ_256M, MT_WRITEBACK_RW_ALLOC},
