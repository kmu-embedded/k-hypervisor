...
#define CFG_MEMMAP_GUEST1_OFFSET   0x90000000
#define CFG_MEMMAP_GUEST2_OFFSET   0xA0000000
#define CFG_MEMMAP_GUEST3_OFFSET   0xB0000000
#define CFG_GUEST_START_ADDRESS    0x80000000

#define CFG_HYP_START_ADDRESS      0xC0000000
